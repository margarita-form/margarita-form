  ...
  build: {
    ...
    lib: {
      ...
      entry: {
        ...
        /* Managers */
        'managers/config-manager': 'src/managers/margarita-form-config-manager.ts',
        'managers/controls-manager': 'src/managers/margarita-form-controls-manager.ts',
        'managers/events-manager': 'src/managers/margarita-form-events-manager.ts',
        'managers/field-manager': 'src/managers/margarita-form-field-manager.ts',
        'managers/params-manager': 'src/managers/margarita-form-params-manager.ts',
        'managers/ref-manager': 'src/managers/margarita-form-ref-manager.ts',
        'managers/state-manager': 'src/managers/margarita-form-state-manager.ts',
        'managers/value-manager': 'src/managers/margarita-form-value-manager.ts',
        /* Extensions */
